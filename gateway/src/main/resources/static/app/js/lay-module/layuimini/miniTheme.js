 ...
 */
layui.define(["jquery", "static.app.page.example.layer"], function (exports) {
    var $ = layui.$,
        layer = layui.layer;
        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http:/.../doc.html" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i>接口文档</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
